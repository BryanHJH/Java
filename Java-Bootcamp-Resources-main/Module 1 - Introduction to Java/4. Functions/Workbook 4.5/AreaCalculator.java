public class AreaCalculator {
    ...
    public static void printAreas() {
        System.out.println("Square area: " + areaSquare(2));
        System.out.println("Rectangle area: " + areaRectangle(1, 2));
        System.out.println("Triangle area: " + areaTriangle(1, 2));
        System.out.println("Circle area: " + areaCircle(2));
    }
